...
mod test {
    ...
    //     // u32 test
    //     for i in 1..100000 {
    //         mediane_u += (u32::MAX.srand() as f32 - mediane_u) / i as f32;
    //     }
    //     // i32 test
    //     let mut mediane_i: f32 = 0.;
    //     for i in 1..100000 {
    //         mediane_i += (i32::MIN.srand() as f32 - mediane_i) / i as f32;
    //     }
    //     // f32 test
    //     let mut mediane_f: f32 = 0.;
    //     for i in 1..100000 {
    //         mediane_f += ((4242.4242).srand() as f32 - mediane_f) / i as f32;
    //     }
    //     eprintln!(
    //         "\nu32 -> {:?}\ni32 -> {:?}\nf32 -> {:?}",
    //         mediane_u,
    ...
    //     let gen_nbr = (0..100000).into_iter().map(|_| u32::srand(1000));
    //     let n_buckets = 50;
